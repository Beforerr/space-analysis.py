...
# %% auto 0
__all__ = ['JunoPhases', 'JunoFGMCoords', 'JunoFGMTimeResolutions', 'load_jno_lbl', 'unpack_and_convert', 'UnpackConvert',
           'download_data']
...
def download_data(
    ...
    url_fmt="https://pds-ppi.igpp.ucla.edu/ditdos/download?id=pds://PPI/{dataset}/DATA/{phase}/{coord}/{datatype}",
    fmt="arrow",
) -> list[str]:
